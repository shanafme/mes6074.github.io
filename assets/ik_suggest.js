...
var pluginName = "ik_suggest",
	defaults = {
		'instructions': 'As you type, suggestions will show in the text box.  Use the up and down arrows to scroll through the suggestion list.  Press enter to make a selection.',
		'minLength': 2,
		'maxResults': 10,
		'source': []
